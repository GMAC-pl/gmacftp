...
**[↓ Download gmacFTP for Mac — gmacFTP-0.0.2.dmg](https://github.com/GMAC-pl/gmacftp/releases/download/v0.0.2/gmacFTP-0.0.2.dmg)** · macOS 11+, Apple Silicon (M-series)
...
**[⬇ gmacFTP-0.0.2.dmg](https://github.com/GMAC-pl/gmacftp/releases/download/v0.0.2/gmacFTP-0.0.2.dmg)** — install steps are at the top of this page.
...
- 🍎 **Natywny.** Prawdziwa apka macOS: własny titlebar, natywne menu, drag-and-drop, jasny/ciemny
  motyw, Apple Silicon (v0.0.2: arm64).
...
**[⬇ Pobierz gmacFTP dla Maca — gmacFTP-0.0.2.dmg](https://github.com/GMAC-pl/gmacftp/releases/download/v0.0.2/gmacFTP-0.0.2.dmg)** · macOS 11+, Apple Silicon (M-series)
